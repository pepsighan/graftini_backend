...
const (
	...
	// FieldGqlAst holds the string denoting the gql_ast field in the database.
	FieldGqlAst = "gql_ast"
	// FieldCreatedAt holds the string denoting the created_at field in the database.
	FieldCreatedAt = "created_at"
	// FieldUpdatedAt holds the string denoting the updated_at field in the database.
	FieldUpdatedAt = "updated_at"
	// EdgeQueryOf holds the string denoting the query_of edge name in mutations.
	EdgeQueryOf = "query_of"
	// Table holds the table name of the graphqlquery in the database.
	Table = "graph_ql_queries"
	// QueryOfTable is the table the holds the query_of relation/edge.
	...
	// QueryOfColumn is the table column denoting the query_of relation/edge.
