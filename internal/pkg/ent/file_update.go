...
func (fu *FileUpdate) SetKind(f file.Kind) *FileUpdate {
	fu.mutation.SetKind(f)
	return fu
}
...
func (fu *FileUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := fu.mutation.Kind(); ok {
...
// SetKind sets the "kind" field.
func (fuo *FileUpdateOne) SetKind(f file.Kind) *FileUpdateOne {
	fuo.mutation.SetKind(f)
	return fuo
}
...
func (fuo *FileUpdateOne) sqlSave(ctx context.Context) (_node *File, err error) {
	...
	if value, ok := fuo.mutation.Kind(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeEnum,
			Value:  value,
			Column: file.FieldKind,
