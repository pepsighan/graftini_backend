...
CREATE TABLE IF NOT EXISTS "pages"("id" uuid NOT NULL, "name" varchar NOT NULL, "route" varchar NOT NULL, "component_map" varchar NULL, "created_at" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP, "project_pages" uuid NULL, PRIMARY KEY("id"));
...
ALTER TABLE "graph_ql_queries" ADD CONSTRAINT "graph_ql_queries_projects_queries" FOREIGN KEY("project_queries") REFERENCES "projects"("id") ON DELETE SET NULL;
ALTER TABLE "pages" ADD CONSTRAINT "pages_projects_pages" FOREIGN KEY("project_pages") REFERENCES "projects"("id") ON DELETE SET NULL;
ALTER TABLE "projects" ADD CONSTRAINT "projects_users_projects" FOREIGN KEY("user_projects") REFERENCES "users"("id") ON DELETE SET NULL;
COMMIT;
